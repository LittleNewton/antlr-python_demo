...
def serializedATN():
    return [
        ...
        0,8,1,1,3,2,5,3,7,4,9,5,11,6,13,7,15,8,1,0,2,1,0,48,57,3,0,10,10,
        ...
        13,32,1,0,0,0,15,35,1,0,0,0,17,18,5,40,0,0,18,2,1,0,0,0,19,20,5,
        41,0,0,20,4,1,0,0,0,21,22,5,42,0,0,22,6,1,0,0,0,23,24,5,47,0,0,24,
        8,1,0,0,0,25,27,7,0,0,0,26,25,1,0,0,0,27,28,1,0,0,0,28,26,1,0,0,
        0,28,29,1,0,0,0,29,10,1,0,0,0,30,31,5,43,0,0,31,12,1,0,0,0,32,33,
        5,45,0,0,33,14,1,0,0,0,34,36,7,1,0,0,35,34,1,0,0,0,36,37,1,0,0,0,
        37,35,1,0,0,0,37,38,1,0,0,0,38,39,1,0,0,0,39,40,6,7,0,0,40,16,1,
        0,0,0,3,0,28,37,1,0,1,0
    ]
...
class CalculatorLexer(Lexer):
    ...
    ruleNames = [ "T__0", "T__1", "T__2", "T__3", "NUM", "PLUS", "MINUS", 
                  "WS" ]
